...
const Footer = () => {
  return (
    <Card radius='none' className="flex flex-col p-2 text-textGray">
      ...
      <div className="flex flex-col sm:flex-row items-center mx-6  justify-between">
        ...
        <div className="flex gap-4 ">
          <Link className="text-textGray" href="/terms">Terms & Conditions</Link>
          <Link className="text-textGray" href="/about">About Us</Link>
          <Link className="text-textGray" href="/privacy">Privacy Policy</Link>
        </div>
      </div>
    </Card>
  );
